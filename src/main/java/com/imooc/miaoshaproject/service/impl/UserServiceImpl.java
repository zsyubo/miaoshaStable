...
public class UserServiceImpl implements UserService {
    ...
    public UserModel getUserByIdInCache(Integer id) {
        UserModel userModel = (UserModel) redisTemplate.opsForValue().get("_user_validate_" + id);
        if (userModel == null) {
            userModel = this.getUserById(id);
            redisTemplate.opsForValue().set("_user_validate_" + id, userModel);
            redisTemplate.expire("_user_validate_" + id, 10, TimeUnit.MINUTES);
        }
        return userModel;
    }
